# ------------------------
# Q. Try changing the type annotation of Person.preferred_operating_system from str to List[str].
...
people = [
    Person(name="Imran", age=22, preferred_operating_systems=[
           "Ubuntu", "Arch Linux"]),
    Person(name="Eliza", age=34, preferred_operating_systems=[
           "Arch Linux", "macOS"]),
]

laptops = [
    Laptop(id=1, manufacturer="Dell", model="XPS",
           screen_size_in_inches=13, operating_system="Arch Linux"),
    Laptop(id=2, manufacturer="Dell", model="XPS",
           screen_size_in_inches=15, operating_system="Ubuntu"),
    Laptop(id=3, manufacturer="Dell", model="XPS",
           screen_size_in_inches=15, operating_system="ubuntu"),
    Laptop(id=4, manufacturer="Apple", model="macBook",
           screen_size_in_inches=13, operating_system="macOS"),
]
