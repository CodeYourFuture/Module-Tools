...
program
    ...
    .option('-l, --lines', 'The number of lines in each input file is written to the standard output.')
    .option('-w, --words', 'The number of words in each input file is written to the standard output.')
    .option('-c, --bytes', 'The number of bytes in each input file is written to the standard output.')
